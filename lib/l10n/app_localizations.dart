...
abstract class AppLocalizations {
  ...
  /// No description provided for @planetReconnectAction.
  ///
  /// In en, this message translates to:
  /// **'Reconnect'**
  String get planetReconnectAction;

  /// No description provided for @planetReconnectInProgress.
  ///
  /// In en, this message translates to:
  /// **'Reconnecting'**
  String get planetReconnectInProgress;

  /// No description provided for @planetReconnectSuccess.
  ///
  /// In en, this message translates to:
  /// **'Reconnected to your planet.'**
  String get planetReconnectSuccess;

  /// No description provided for @planetReconnectFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to reconnect to your planet.'**
  String get planetReconnectFailed;
